...
clone_or_update https://github.com/flightaware/piaware.git v3.7.1 $OUTDIR/piaware

clone_or_update https://github.com/flightaware/tcllauncher.git v1.8 $OUTDIR/tcllauncher

clone_or_update https://github.com/flightaware/dump1090.git v3.7.1 $OUTDIR/dump1090
